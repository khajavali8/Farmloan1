...
//     fetchInvestments();
//     const interval = setInterval(fetchInvestments, 5000); 
...
//   {investments.filter(inv => !inv.verified).length === 0 ? (
//     <p style={styles.noLoans}>No pending investment requests.</p>
//   ) : (
//     <div style={styles.loanGrid}>
//       {investments
//         .filter(inv => !inv.verified) // Show only unverified ones
//         .map((inv) => (
          ...
          <div style={styles.popupContent}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={styles.popupButtons}>
                ...
                <button type="button" onClick={closePopup} style={styles.cancelButton}>
                  Cancel
                </button>
              </div>
            </form>
